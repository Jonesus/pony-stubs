...
class Attribute:
    ...
    def __init__(attr, py_type: Any, *args: Any, **kwargs: Any) -> None: ...
...
class Collection(Attribute):
    def __init__(attr, py_type: Any, *args: Any, **kwargs: Any) -> None: ...
    def load(attr, obj: Any) -> None: ...
    def __get__(attr, obj: Any, cls: Any | None = ...) -> None: ...
...
class SetInstance:
    ...
    def copy(wrapper) -> Any: ...
    def __nonzero__(wrapper) -> Any: ...
    def is_empty(wrapper) -> Any: ...
    def __len__(wrapper) -> Any: ...
    def count(wrapper) -> Any: ...
    def __iter__(wrapper) -> Any: ...
    def __eq__(wrapper, other: Any) -> Any: ...
    def __ne__(wrapper, other: Any) -> Any: ...
    def __add__(wrapper, new_items: Any) -> Any: ...
    def __sub__(wrapper, items: Any) -> Any: ...
    def __contains__(wrapper, item: Any) -> Any: ...
    def create(wrapper, **kwargs: Any) -> Any: ...
    def add(wrapper, new_items: Any) -> None: ...
    def __iadd__(wrapper, items: Any) -> Any: ...
    def remove(wrapper, items: Any) -> None: ...
    def __isub__(wrapper, items: Any) -> Any: ...
    def clear(wrapper) -> None: ...
    def load(wrapper) -> None: ...
    def select(wrapper, *args: Any, **kwargs: Any) -> Any: ...
    filter: Any
    def limit(wrapper, limit: Any | None = ..., offset: Any | None = ...) -> Any: ...
    def page(wrapper, pagenum: Any, pagesize: int = ...) -> Any: ...
    def order_by(wrapper, *args: Any) -> Any: ...
    def sort_by(wrapper, *args: Any) -> Any: ...
    def random(wrapper, limit: Any) -> Any: ...
...
class EntityMeta(type):
    ...
    def __iter__(entity: Type[EntityType]) -> EntityType: ...
    def __getitem__(entity: Type[EntityType], key: Any) -> EntityType: ...
    def exists(entity, *args: Any, **kwargs: Any) -> bool: ...
    def get(entity: Type[EntityType], *args: Any, **kwargs: Any) -> EntityType: ...
    def get_for_update(
    ...
    def select(entity: Type[EntityType], *args: Any, **kwargs: Any) -> EntityType: ...
    def select_by_sql(
        entity: Type[EntityType],
        sql: str,
        globals: Union[dict[str, Any], None] = ...,
    ...
    def select_random(entity: Type[EntityType], limit: Any) -> EntityType: ...
...
Other = TypeVar("Other", bound="Entity")

class Entity(metaclass=EntityMeta):
    def __reduce__(obj) -> Any: ...
    def __init__(obj, *args: Any, **kwargs: Any) -> None: ...
    def get_pk(obj) -> Any: ...
    def __lt__(entity: Other, other: Other) -> bool: ...
    def __le__(entity: Other, other: Other) -> bool: ...
    def __gt__(entity: Other, other: Other) -> bool: ...
    def __ge__(entity: Other, other: Other) -> bool: ...
    ...
    # Additional stubs for type inference
    def __next__(self) -> Self: ...  # type: ignore

def select(generator: Iterable[EntityType]) -> Query[EntityType]: ...
...
class Query(Generic[QueryType]):
    ...
    def get_sql(query) -> Any: ...
    def prefetch(query, *args: Any) -> Any: ...
    def show(query, width: Any | None = ..., stream: Any | None = ...) -> None: ...
    def get(query) -> Any: ...
    def first(query) -> QueryType: ...
    def without_distinct(query) -> Any: ...
    def distinct(query) -> Any: ...
    def exists(query) -> bool: ...
    def delete(query, bulk: Any | None = ...) -> Any: ...
    def __len__(query) -> int: ...
    def __iter__(query) -> Generator[QueryType, None, None]: ...
    def order_by(query, *args: Any) -> Any: ...
    def sort_by(query, *args: Any) -> Any: ...
    @overload
    def filter(query, callback: Callable[[QueryType], bool]) -> "Query"[QueryType]: ...
    @overload
    def filter(query, *args: Any, **kwargs: Any) -> "Query"[QueryType]: ...
    def where(query, *args: Any, **kwargs: Any) -> Any: ...
    def __getitem__(query, key: Any) -> QueryType: ...
    def fetch(query, limit: Any | None = ..., offset: Any | None = ...) -> Any: ...
    def limit(query, limit: Any | None = ..., offset: Any | None = ...) -> Any: ...
    def page(query, pagenum: Any, pagesize: int = ...) -> Any: ...
    def sum(query, distinct: Any | None = ...) -> Any: ...
    def avg(query, distinct: Any | None = ...) -> Any: ...
    def group_concat(
        query, sep: Any | None = ..., distinct: Any | None = ...
    ) -> Any: ...
    def min(query) -> Any: ...
    def max(query) -> Any: ...
    def count(query, distinct: Any | None = ...) -> Any: ...
    def for_update(query, nowait: bool = ..., skip_locked: bool = ...) -> Any: ...
    def random(query, limit: Any) -> Any: ...
    def to_json(
        query,
        include: Any = ...,
        exclude: Any = ...,
